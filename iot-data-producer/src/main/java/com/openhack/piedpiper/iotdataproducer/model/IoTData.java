package com.openhack.piedpiper.iotdataproducer.model;
...
public class IoTData implements Serializable {
    ...
    public IoTData(String vehicleId, String vehicleType, String routeId, String latitude, String longitude, double temperature,
                   long assetCount, List<Asset> assetDetails, Date timestamp, double speed, double fuelLevel,String startLocation
            ,String endLocation) {
        super();
